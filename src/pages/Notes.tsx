            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 my-8">
                {notes && notes.map((note) => (
                    <Link
                        ...
                        key={note.note_id}
                        dir='auto'
                        className="size-hover min-h-32 p-6 rounded-xl border border-[#2c2c2c49]  hover:shadow-md transition-all" style={{ background: `${note.background_color}` }}
                    >
                        <p
                            className="text-xl font-semibold mb-2" style={{ color: getTextColor(note.background_color) }}
                            dir='auto'
                        >
                            {note.title}
                        </p>
