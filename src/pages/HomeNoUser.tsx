...
const HomeNoUser = () => {
    ...
    return (
        <div className="add min-h-screen" style={{ background: 'var(--color-bg)' }}>
            <button className="bg-amber-300 w-32 fixed" onClick={()=> setIsDark(!isDark)}>Toggle theme</button>
            {/* Hero Section */}
            <section className="py-20 px-4 text-center">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-5xl md:text-6xl font-bold mb-6" style={{ color: 'var(--logo-my)' }}>
                        <span style={{ color: 'var(--color-text)' }}>Wlcom to </span> My<span style={{ color: 'var(--logo-note)' }}>Notes</span>
                    </h1>
                    ...
                    <button className="light-gradient cursor-pointer text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:scale-105">
                        Start Taking Notes
                    </button>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="p-6 rounded-xl hover:shadow-md transition-all" style={{background:'var(--card-color-1)'}}>
                            ...
                            <h3 className={`text-xl font-semibold ${isDark?"dark:text-purple-500":"text-purple-800"} mb-2`}>Tag System</h3>
                        ...
                        <div className="p-6 rounded-xl hover:shadow-md transition-all" style={{background:'var(--card-color-2)'}}>
                            ...
                            <h3 className={`text-xl font-semibold ${isDark?"dark:text-blue-500":"text-blue-800"} mb-2`}>Simple Editing</h3>
                            <p style={{color:'var(--color-text)'}}>
