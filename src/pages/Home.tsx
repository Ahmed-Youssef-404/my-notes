                                ...
                                <>
                                    ...
                                    <div className="m-4 mt-0 md:m-8">
                                        ...
                                        <button
                                            ...
                                            className="button-gradient cursor-pointer text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:scale-105"
                                        >
                                            Show all tags
                                        </button>
                                    </div>
